...
plt.ylabel('Loss')
plt.xlabel('Epoch')
plt.savefig('variational_losses_mse6.png')
...
fig1.savefig('variational_recon_mse6.png')
...
fig2.savefig('variational_hist_mse6.png')
...
plt.savefig('variational_cm_mse6.png')
print(cm)
