...
plt.ylabel('Loss')
plt.xlabel('Epoch')
plt.savefig('standard_ae_losses_bce' + str(file_number) + '.png')
...
fig1.savefig('standard_ae_recon_bce' + str(file_number) + '.png')
# fig1.savefig('testrecon.png')  
 
 
# fig2 = plt.figure()
train_loss = tf.keras.losses.binary_crossentropy(pred, test_set)
testing_thresholds = [np.mean(train_loss), np.mean(train_loss) + np.std(train_loss), np.mean(train_loss) + np.std(train_loss) + np.std(train_loss),0.4,0.45,0.5,0.55,0.6,0.65,0.7,0.75,0.8]
...
for threshold in testing_thresholds:
    ...
    fig.savefig('standard_ae_hist_bce' + str(file_number) + '_' + str(testing_thresholds.index(threshold)) + '.png')
    ...
    fig1.savefig('standard_ae_cm_bce' + str(file_number) + '_' + str(testing_thresholds.index(threshold)) + '.png')
