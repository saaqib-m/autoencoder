...
pred_labels1 = []
for i in range(len(train_loss)):
    if (np.mean(train_loss[i])) > threshold1:
...
pred_labels2 = []
for i in range(len(train_loss)):
    if (np.mean(train_loss[i])) > threshold2:
...
pred_labels3 = []
for i in range(len(train_loss)):
    if (np.mean(train_loss[i])) > threshold3:
...
pred_labels4 = []
for i in range(len(train_loss)):
    if (np.mean(train_loss[i])) > threshold4:
...
pred_labels5 = []
for i in range(len(train_loss)):
    if (np.mean(train_loss[i])) > threshold5:
...
pred_labels6 = []
for i in range(len(train_loss)):
    if (np.mean(train_loss[i])) > threshold6:
...
pred_labels7 = []
for i in range(len(train_loss)):
    if (np.mean(train_loss[i])) > threshold7:
...
pred_labels8 = []
for i in range(len(train_loss)):
    if (np.mean(train_loss[i])) > threshold8:
