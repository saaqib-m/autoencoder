...
plt.ylabel('Loss')
plt.xlabel('Epoch')
plt.savefig('variational_losses_mse' + str(file_number) + '.png')
...
fig1.savefig('variational_recon_mse' + str(file_number) + '.png')
...
testing_thresholds = [np.mean(train_loss), np.mean(train_loss) + np.std(train_loss), np.mean(train_loss) + np.std(train_loss) + np.std(train_loss), 0.002, 0.003, 0.004, 0.005, 0.006]
...
for threshold in testing_thresholds:
    ...
    fig.savefig('variational_hist_mse' + str(file_number) + '_' + str(testing_thresholds.index(threshold)) + '.png')
    ...
    fig1.savefig('variational_cm_mse' + str(file_number) + '_' + str(testing_thresholds.index(threshold)) + '.png')
